...
TEST_F(InitFixture, TestLEDpinModes)
{
    ...
    EXPECT_SX1509_ANALOG_WRITE(OUTPUT_LED_ARRAY_I2C_DEVICE, OUTPUT_LED_ARRAY_RED_QUAD_1, MAXIMUM_ANALOG_OUTPUT_VALUE);
    EXPECT_SX1509_ANALOG_WRITE(OUTPUT_LED_ARRAY_I2C_DEVICE, OUTPUT_LED_ARRAY_RED_QUAD_2, MAXIMUM_ANALOG_OUTPUT_VALUE);
    EXPECT_SX1509_ANALOG_WRITE(OUTPUT_LED_ARRAY_I2C_DEVICE, OUTPUT_LED_ARRAY_RED_QUAD_3, MAXIMUM_ANALOG_OUTPUT_VALUE);
    EXPECT_SX1509_ANALOG_WRITE(OUTPUT_LED_ARRAY_I2C_DEVICE, OUTPUT_LED_ARRAY_RED_QUAD_4, MAXIMUM_ANALOG_OUTPUT_VALUE);
...
TEST_F(InitFixture, TestPWMInitiaitzation)
{
    ...
    EXPECT_CALL(*io->accessMockPWM(), setPin(OUTPUT_TRANSDUCER, PWM_INDICATOR_OFF_VALUE, FALSE));
