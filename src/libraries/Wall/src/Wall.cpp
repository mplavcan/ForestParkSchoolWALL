...
void WallImplementation::initializeLEDarrayOutputs(void)
{
    ...
    io_expander[OUTPUT_LED_ARRAY_I2C_DEVICE]->analogWrite(OUTPUT_LED_ARRAY_RED_QUAD_1, MINIMUM_ANALOG_OUTPUT_VALUE);
    io_expander[OUTPUT_LED_ARRAY_I2C_DEVICE]->analogWrite(OUTPUT_LED_ARRAY_RED_QUAD_2, MINIMUM_ANALOG_OUTPUT_VALUE);
    io_expander[OUTPUT_LED_ARRAY_I2C_DEVICE]->analogWrite(OUTPUT_LED_ARRAY_RED_QUAD_3, MINIMUM_ANALOG_OUTPUT_VALUE);
    io_expander[OUTPUT_LED_ARRAY_I2C_DEVICE]->analogWrite(OUTPUT_LED_ARRAY_RED_QUAD_4, MINIMUM_ANALOG_OUTPUT_VALUE);
}
