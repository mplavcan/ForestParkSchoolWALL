...
// Large LED buttons
#define BLUE_BUTTON_I2C_DEVICE         SPARKFUN_SX1509_THIRD_I2C_ADDRESS 
#define BLUE_LED_I2C_DEVICE            SPARKFUN_SX1509_THIRD_I2C_ADDRESS
#define BLUE_BUTTON_PIN                 8
#define BLUE_LED_PIN                    9
#define YELLOW_BUTTON_I2C_DEVICE       SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
#define YELLOW_LED_I2C_DEVICE          SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
#define YELLOW_BUTTON_PIN              10
#define YELLOW_LED_PIN                 11
#define GREEN_BUTTON_I2C_DEVICE        SPARKFUN_SX1509_SECOND_I2C_ADDRESS
#define GREEN_LED_I2C_DEVICE           SPARKFUN_SX1509_SECOND_I2C_ADDRESS
#define GREEN_BUTTON_PIN                7
#define GREEN_LED_PIN                   6
#define RED_BUTTON_I2C_DEVICE          SPARKFUN_SX1509_SECOND_I2C_ADDRESS
#define RED_LED_I2C_DEVICE             SPARKFUN_SX1509_SECOND_I2C_ADDRESS
#define RED_BUTTON_PIN                  5
#define RED_LED_PIN                     4
#define WHITE_BUTTON_I2C_DEVICE        SPARKFUN_SX1509_FIRST_I2C_ADDRESS
#define WHITE_LED_I2C_DEVICE           SPARKFUN_SX1509_FIRST_I2C_ADDRESS
...
// Digital Inputs
#define INPUT_TOGGLE_I2C_DEVICE        SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
#define INPUT_TOGGLE_1                  0 
#define INPUT_TOGGLE_2                  1
#define INPUT_TOGGLE_3                  2

#define INPUT_JOYSTICK_I2C_DEVICE      SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
...
// Analog Inputs
#define INPUT_ROTARY_POT_I2C_DEVICE    ADAFRUIT_ANALOG_FIRST_I2C_ADDRESS
#define INPUT_ROTARY_POT                0

#define INPUT_PHOTO_SENSOR_I2C_DEVICE  ADAFRUIT_ANALOG_FIRST_I2C_ADDRESS
#define INPUT_PHOTO_SENSOR_1            1
#define INPUT_PHOTO_SENSOR_2            2
#define INPUT_PHOTO_SENSOR_3            3

#define INPUT_LINEAR_POT_I2C_DEVICE    ADAFRUIT_ANALOG_SECOND_I2C_ADDRESS
#define INPUT_LINEAR_POT                0

#define INPUT_FORCE_SENSOR_I2C_DEVICE  ADAFRUIT_ANALOG_SECOND_I2C_ADDRESS
#define INPUT_FORCE_SENSOR_1            1 
#define INPUT_FORCE_SENSOR_2            2
#define INPUT_FORCE_SENSOR_3            3

// Motor controller outputs
#define OUTPUT_MOTOR_I2C_DEVICE        SPARKFUN_SX1509_FIRST_I2C_ADDRESS
...
#define OUTPUT_LED_ARRAY_1_LEFT         2
#define OUTPUT_LED_ARRAY_1_RIGHT        3
#define OUTPUT_LED_ARRAY_3_QUAD_1       8
#define OUTPUT_LED_ARRAY_3_QUAD_2       9
#define OUTPUT_LED_ARRAY_3_QUAD_3      10
#define OUTPUT_LED_ARRAY_3_QUAD_4      11

// Hex grid input/output nets
#define GRID_ROTARY_POT_I2C_DEVICE     SPARKFUN_SX1509_THIRD_I2C_ADDRESS
#define GRID_LINEAR_POT_I2C_DEVICE     SPARKFUN_SX1509_THIRD_I2C_ADDRESS
#define GRID_PHOTO_SENSOR_I2C_DEVICE   SPARKFUN_SX1509_THIRD_I2C_ADDRESS
#define GRID_JOYSTICK_I2C_DEVICE       SPARKFUN_SX1509_THIRD_I2C_ADDRESS
#define GRID_TOGGLE_SWITCH_I2C_DEVICE  SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
#define GRID_FORCE_SENSOR_I2C_DEVICE   SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
...
#define GRID_BATTERY_I2C_DEVICE        SPARKFUN_SX1509_FOURTH_I2C_ADDRESS
#define GRID_BATTERY_NEGATIVE           8   
#define GRID_BATTERY_POSTIVE            9

#define GRID_TRANSDUCER_I2C_DEVICE     SPARKFUN_SX1509_FIRST_I2C_ADDRESS
#define GRID_LED_ARRAY_2_I2C_DEVICE    SPARKFUN_SX1509_FIRST_I2C_ADDRESS
#define GRID_LED_ARRAY_3_I2C_DEVICE    SPARKFUN_SX1509_FIRST_I2C_ADDRESS
#define GRID_MOTOR_1_I2C_DEVICE        SPARKFUN_SX1509_FIRST_I2C_ADDRESS
#define GRID_MOTOR_2_I2C_DEVICE        SPARKFUN_SX1509_SECOND_I2C_ADDRESS
#define GRID_LED_ARRAY_1_I2C_DEVICE    SPARKFUN_SX1509_SECOND_I2C_ADDRESS
#define GRID_TRANSDUCER_LEFT            2
#define GRID_TRANSDUCER_RIGHT           1
#define GRID_LED_ARRAY_2_LEFT           3
#define GRID_LED_ARRAY_2_RIGHT          0
#define GRID_LED_ARRAY_3_LEFT           4
#define GRID_LED_ARRAY_3_RIGHT          5
#define GRID_MOTOR_1_LEFT               7
#define GRID_MOTOR_1_RIGHT              6
#define GRID_MOTOR_2_LEFT              15
#define GRID_MOTOR_2_RIGHT             14
#define GRID_LED_ARRAY_1_LEFT          13
#define GRID_LED_ARRAY_1_RIGHT         12
