...
// Analog Inputs
#define INPUT_ROTARY_POT_I2C_DEVICE    SECOND_ADS1015_INDEX
#define INPUT_ROTARY_POT                0
#define INPUT_ROTARY_POT_LEFT_LIMIT    0
#define INPUT_ROTARY_POT_RIGHT_LIMIT   1100
...
#define INPUT_PHOTO_BRIGHT_LIMIT       757
#define INPUT_PHOTO_DARK_LIMIT         104

#define INPUT_LINEAR_POT_I2C_DEVICE    FIRST_ADS1015_INDEX
#define INPUT_LINEAR_POT                0
#define INPUT_LINEAR_POT_LEFT_LIMIT    0
#define INPUT_LINEAR_POT_RIGHT_LIMIT   1100
#define INPUT_LINEAR_POT_MIDDLE_POSITION ((INPUT_LINEAR_POT_LEFT_LIMIT + INPUT_LINEAR_POT_RIGHT_LIMIT)/2)
...
#define INPUT_FORCE_SENSOR_LIGHT_LIMIT 0
#define INPUT_FORCE_SENSOR_HEAVY_LIMIT 1085

// Motor controller outputs
#define OUTPUT_MOTOR_I2C_DEVICE        FIRST_SX1509_INDEX
#define OUTPUT_MOTOR2_PWM               8  
