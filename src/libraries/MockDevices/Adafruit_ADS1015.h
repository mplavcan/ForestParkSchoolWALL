...
class MockAdafruit_ADS1015 : public Adafruit_ADS1015
{
  public:
    ...
    MOCK_METHOD1(readADC_SingleEnded, uint16_t (uint8_t));
    MOCK_METHOD0(readADC_Differential_0_1, int16_t (void));
    MOCK_METHOD0(readADC_Differential_2_3, int16_t (void));
    MOCK_METHOD2(startComparator_SingleEnded, void (uint8_t, int16_t));
    MOCK_METHOD0(getLastConversionResults, int16_t (void));
    MOCK_METHOD1(setGain, void (adsGain_t));
